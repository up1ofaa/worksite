...
function USR_MAIN(args){
	...
	switch(args){
			case 'owpac01_s01':
					com_send('owpac01_s01', {"pgm_id":"owpac01_i01"}, 'res_owpac01_s01');
				break;
			case 'owpac01_i01':
					...
					inRec.list    =list;
					com_send('owpac01_i01', inRec, 'res_owpac01_i01');
				break;
			default :
				break;	
	}	
...
function res_owpac01_s01(outRec){
	USR_INIT();
	USR_VIEW_SELECT(1);
	...
	for(var i=0; i <cnt; i++){
		...
		new_cell2.innerHTML= "<input type='text' name='course_id' 		readonly='readonly' value='"+outRec.dlt_rsList[i].course_id		+"'>";
		new_cell3.innerHTML= "<input type='text' name='title'	  		readonly='readonly' value='"+outRec.dlt_rsList[i].title			+"'>";
		new_cell4.innerHTML= "<input type='text' name='c_number'    						value='"+outRec.dlt_rsList[i].c_number		+"'>";  
		new_cell5.innerHTML= "<input type='text' name='professor_id' 	readonly='readonly' value='"+outRec.dlt_rsList[i].professor_id	+"'>"; 
		new_cell6.innerHTML= "<input type='text' name='course_fee'	 						value='"+outRec.dlt_rsList[i].course_fee		+"'>";   	
	}// end-for	
}//end-function



function res_owpac01_i01(outRec){
	USR_INIT();
	USR_VIEW_SELECT(2);
...
<input type="button" value="비동기조회" onclick="USR_MAIN('owpac01_s01');">
<input type="button" value="전체수정(프로시져 호출)" onclick="USR_MAIN('owpac01_u01');">
</div>
<div id="defaultDiv">
